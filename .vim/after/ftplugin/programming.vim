...
nnoremap <silent><nowait>         ,           :call <SID>show_diagnostic()<CR>
nnoremap <silent><nowait>         K           :call <SID>show_documentation()<CR>
nnoremap <silent><nowait>         <leader>rn  <Plug>(coc-rename)
nnoremap <silent><nowait>         <leader>rf  <Plug>(coc-codeaction-refactor)
nnoremap <silent><nowait>         <leader>qa  <Plug>(coc-codeaction)
nnoremap <silent><nowait>         <leader>lw  :<C-u>CocDiagnostics<CR>
nnoremap <silent><nowait>         <leader>lW  :<C-u>lcl<CR>
nnoremap <silent><nowait>         [l          <Plug>(coc-diagnostic-prev)
nnoremap <silent><nowait>         ]l          <Plug>(coc-diagnostic-next)
nnoremap <silent><nowait>         ]L          :<C-u>lfirst<CR>
nnoremap <silent><nowait>         [L          :<C-u>llast<CR>
